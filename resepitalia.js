...
let jbahan16 = parseFloat(document.getElementById('b16').innerHTML);
...
function plus(){
    ...
    document.getElementById('b16').innerHTML = parseFloat(document.getElementById('b16').innerHTML) + jbahan16;
}
